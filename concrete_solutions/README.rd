...
- Fiz os testes unitários sem importar o unittest, geralmente os rubystas fazem com o Rspec, não com o unittest,  como são testes com a mesma função não vi necessidade de importar uma biblioteca para isso, com uma simples função podemos fazer isso.
